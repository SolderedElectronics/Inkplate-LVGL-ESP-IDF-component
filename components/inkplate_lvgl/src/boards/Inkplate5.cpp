...
Inkplate5::Inkplate5(lv_display_render_mode_t mode) : BoardCommon(E_INK_WIDTH, E_INK_HEIGHT, 21, 12) {
...
{
    Inkplate5 *self = static_cast<Inkplate5 *>(lv_display_get_user_data(disp));
