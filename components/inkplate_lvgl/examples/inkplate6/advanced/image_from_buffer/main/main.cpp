 ...
 * @brief       Display image from RAM buffer on Soldered Inkplate 6.
 *
 * @details     Renders an 800x600 L8 (grayscale, 1 byte/pixel) image stored in
...
// cat.h: 800x600, L8 grayscale (1 byte/pixel), array size = CAT_WIDTH * CAT_HEIGHT
