 ...
 * @brief       Color palette example for Soldered Inkplate 7 with LVGL.
 *
 * @details     Demonstrates the 6 native colors of the Inkplate 7 e-paper
 *              display (black, white, yellow, red, blue, green) by rendering
