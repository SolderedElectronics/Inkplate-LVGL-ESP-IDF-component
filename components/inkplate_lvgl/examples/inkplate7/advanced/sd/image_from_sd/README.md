...
Display JPEG images from an SD card on Soldered Inkplate 7 using LVGL.
...
Copy `picture1.jpg` and `picture2.jpg` to the root of a FAT32-formatted microSD card and insert it into the Inkplate 7.
