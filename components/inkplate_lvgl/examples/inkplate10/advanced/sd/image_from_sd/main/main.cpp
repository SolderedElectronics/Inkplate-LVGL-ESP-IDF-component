 ...
 * @brief       Display JPEG image from SD card on Soldered Inkplate 10.
 *
 ...
 * - Hardware:   Inkplate 10, USB cable, microSD card with cat.jpg in root
 * - Extra:      microSD card
 *
 * Configuration:
 ...
 * 2) Insert the SD card into Inkplate 10.
 * 3) Build and flash.
