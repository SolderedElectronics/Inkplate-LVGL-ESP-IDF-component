...
Display a JPEG image from an SD card on Soldered Inkplate 10 using LVGL.
...
Copy `cat.jpg` to the root of a FAT-formatted microSD card and insert it into the Inkplate 10.
