 ...
 * @brief       RTC calibration example for Soldered Inkplate 13 with LVGL.
 *
 ...
 *              tracks time after the wake button press. Time is printed to serial
 ...
 * 3) Press the wake button (GPIO18) when prompted on the display.
...
#define WAKE_BUTTON_PIN GPIO_NUM_18
...
extern "C" void app_main(void) {
    ...
    // Wait for button press (LOW = pressed, internal pull-up keeps HIGH when idle)
