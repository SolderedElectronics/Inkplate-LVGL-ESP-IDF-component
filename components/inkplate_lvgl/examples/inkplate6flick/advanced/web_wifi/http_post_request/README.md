...
Send an HTTP POST request and display the result on Soldered Inkplate 6Flick using LVGL.
...
Display shows POST result (HTTP status code and response snippet).
