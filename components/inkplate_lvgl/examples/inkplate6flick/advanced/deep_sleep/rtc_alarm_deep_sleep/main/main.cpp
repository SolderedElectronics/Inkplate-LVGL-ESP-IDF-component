 ...
 * @brief       RTC alarm deep sleep example for Soldered Inkplate 6Flick.
 *
 ...
 * - Hardware:   Inkplate 6Flick, USB cable, CR2032 battery (optional)
 * - Extra:      None
 *
 * Configuration:
...
extern "C" void app_main(void) {
    ...
    // Any other wakeup (power-on, reset, USB flash) must set the time even if the
    // PCF85063A RAM byte claims it was previously set.
