 ...
 * @brief       Display JPEG image from SD card on Soldered Inkplate 6Flick.
 *
 ...
 * - Hardware:   Inkplate 6Flick, USB cable, microSD card with cat.jpg in root
 * - Extra:      microSD card
 *
 * Configuration:
 ...
 * 2) Insert the SD card into Inkplate 6Flick.
 * 3) Build and flash.
