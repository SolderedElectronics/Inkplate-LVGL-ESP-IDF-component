 ...
 * @brief       Display image from RAM buffer on Soldered Inkplate 5.
 *
 * @details     Renders a 1280x720 L8 (grayscale, 1 byte/pixel) image stored in
...
// cat.h: 1280x720, L8 grayscale (1 byte/pixel), array size = CAT_WIDTH * CAT_HEIGHT
