 ...
 * @brief       Display JPEG image from SD card on Soldered Inkplate 4.
 *
 ...
 * - Hardware:   Inkplate 4, USB cable, microSD card with cat.jpg in root
 * - Extra:      microSD card
 *
 * Configuration:
 ...
 * 2) Insert the SD card into Inkplate 4.
 * 3) Build and flash.
