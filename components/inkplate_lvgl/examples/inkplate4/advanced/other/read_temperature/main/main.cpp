 ...
 * @brief       Temperature reading example for Soldered Inkplate 4.
 *
 * @details     Reads the panel temperature and displays it on the e-ink panel.
 *              The display refreshes every 10 seconds using fast partial update.
 *
 * Requirements:
